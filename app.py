...
if st.session_state["access_token"]:
    ...
    # --- Simple Daily Historical Analysis (Button as requested) ---
    st.subheader("Simple Daily Chart")
    ...
    # --- Advanced Historical Analysis with MTFA Logic ---
    st.subheader("Advanced Historical Analysis (with MTFA & Filters)")
    ...
    if st.button("Start Intraday Bar-Close Analysis"): # Renamed as requested
    ...
    if st.session_state["live_running"]:
        ...
        # The following placeholders are now managed within `run_analysis_logic`
